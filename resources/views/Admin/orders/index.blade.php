...
<script type="text/javascript">        
     ...
     // alert("check");
        ...
        $('#usersjtable').jtable({
                ...
                actions: {
                    listAction: "{{ route('admin.orders.orderajaxlist') }}",
                },
                fields: {
              sno: { 
                    key: true,
              ...
              voucher_url: {
                    ...
                    {
                      if(data.record.voucher_url !=''){
                       return "<label ><img src='"+data.record.voucher_url+"' style='width:60px;'></label>";
                      } 
                    }
              },  
              card_no: {
