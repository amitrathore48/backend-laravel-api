          ...
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('/admin/host-profiles')}}" class="btn btn-sm btn-neutral">Back</a>
               ...
               <a href="{{url('/admin/gift-history', [$profile->id])}}" class="btn btn-sm btn-neutral">Gift History</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0"><i class='fa fa-phone' style='font-size:20px;'></i> Call History of  {{  $profile->username }}</h3>
            </div>
...
<script type="text/javascript">        
     $(document).ready(function () {
        ...
        $('#usersjtable').jtable({
                ...
                actions: {
                    listAction: "{{ url('admin/ajaxcallhistory', [$profile->id]) }}",
                },
                fields: {
              sno: { 
                    key: true,
